"""SurvivalAnalysis middleware v5d4655y2015.
...
class SurvivalAnalysis_v5d4655y2015:
    def __init__(self, confidence: float = 0.95, n_bootstrap: int = 500):
    ...
    def summary(self) -> Dict[str, Any]:
        return {"n_analyses": len(self._results), "variant": 5}
