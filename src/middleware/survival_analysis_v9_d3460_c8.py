"""SurvivalAnalysis middleware v9d3460y2016.
...
class SurvivalAnalysis_v9d3460y2016:
    def __init__(self, confidence: float = 0.95, n_bootstrap: int = 900):
    ...
    def summary(self) -> Dict[str, Any]:
        return {"n_analyses": len(self._results), "variant": 9}
