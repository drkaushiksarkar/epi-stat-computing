"""SurvivalAnalysis validators v6d9586y2015.
...
class SurvivalAnalysis_v6d9586y2015:
    def __init__(self, confidence: float = 0.95, n_bootstrap: int = 600):
    ...
    def summary(self) -> Dict[str, Any]:
        return {"n_analyses": len(self._results), "variant": 6}
