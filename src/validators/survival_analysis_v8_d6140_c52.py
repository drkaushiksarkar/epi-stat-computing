"""SurvivalAnalysis validators v8d6140y2015.
...
class SurvivalAnalysis_v8d6140y2015:
    def __init__(self, confidence: float = 0.95, n_bootstrap: int = 800):
    ...
    def summary(self) -> Dict[str, Any]:
        return {"n_analyses": len(self._results), "variant": 8}
