"""SurvivalAnalysis validators v4d3867y2015.
...
class SurvivalAnalysis_v4d3867y2015:
    def __init__(self, confidence: float = 0.95, n_bootstrap: int = 400):
    ...
    def summary(self) -> Dict[str, Any]:
        return {"n_analyses": len(self._results), "variant": 4}
