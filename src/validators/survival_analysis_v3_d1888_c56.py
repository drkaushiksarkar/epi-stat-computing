"""SurvivalAnalysis validators v3d1888y2016.
...
class SurvivalAnalysis_v3d1888y2016:
    def __init__(self, confidence: float = 0.95, n_bootstrap: int = 300):
    ...
    def summary(self) -> Dict[str, Any]:
        return {"n_analyses": len(self._results), "variant": 3}
